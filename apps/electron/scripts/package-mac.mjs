...
cpSync(canvasBinaryPackage, join(staging, `node_modules/@napi-rs/canvas-darwin-${process.arch === 'arm64' ? 'arm64' : 'x64'}`), { recursive: true });
...
await esbuild({
  ...
  external: ['fsevents', '@napi-rs/canvas', '@napi-rs/canvas-darwin-arm64', '@napi-rs/canvas-darwin-x64'],
  sourcemap: false,
});
